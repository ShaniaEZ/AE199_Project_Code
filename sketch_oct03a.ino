...
void setup() {
  ...
  if (dataFile) {
    ...
    String header = "Miliseconds, Temperature(Cdegrees), Pressure, AltitudeTemp, AltitudePressure";
    /***************************************************************************/
...
void loop() {
  ...
  dataString += ", ";
  dataString += String(altitude_temp(temp));
  dataString += ", ";
  dataString += String(altitude_pressexp(pressure));
  dataString += ", ";
  dataString += String(altitude_presslin(pressure));
  dataString += ", ";
  /**************************************************************************/
...
float altitude_pressexp(float pressure){
  return 44405.24-44383.67*pow((pressure/101290) , 1/5.265);
}

float altitude_presslin(float pressure){
